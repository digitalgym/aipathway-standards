---
name: follow-up
description: Chasing what is owed to the business that is not money. A quote decision, a signed variation, a certificate, a purchase order number or a form, each an open item with a kind, an owner on the other side and a due date; ranked by value at risk then age; a capped cadence on channels with consent; a call that discloses first and records one outcome as a date or a decision; stops the moment the item arrives; escalates to a person on a no, a dispute or the cap. The call is the hosted step. Free to implement, with a conformance checklist. Use when building, reviewing or auditing this workflow. Carries the AIP-BS-FOLLOW-UP open standard, free to implement under CC BY 4.0.
license: CC-BY-4.0
...
never:
  - "chase without an open item"
  - "rank by age alone"
  - "touch past the cap or without consent"
  - "touch after the item arrived or after a no"
  - "offer a discount or a concession to get an answer"
stays_with_person:
  - "the no, and anything disputed"
  - "dropping an item"
  - "any concession"
---
...
**Spec:** AIP-BS-FOLLOW-UP · **Version:** 2026-09-26 · **Canonical:** https://aipathway.com.au/explore-ai/follow-up-build-standard
...
The full specification is in `reference/follow-up.md` in this skill. Read it
...
For the current version, fetch https://aipathway.com.au/explore-ai/follow-up-build-standard.md. This copy is 2026-09-26.

The checks are also structured data, so you do not have to infer a test plan from
the prose: https://aipathway.com.au/explore-ai/follow-up-build-standard/checks.json gives each check a stable id, the ports it
observes, what to inject and what to assert. `npx @aipathway/conformance show
follow-up-build-standard` prints them and comes with a stub and a runner, so a build can be
...
AIP-BS-FOLLOW-UP, 2026-09-26, AI Pathway, https://aipathway.com.au/explore-ai/follow-up-build-standard
