...
never:
  - "classify onto a kind the list does not hold"
  - "file a copy in a folder instead of against the record"
  - "reply with a price, a date or a decision without a release"
  - "touch a complaint"
  - "delete spam"
stays_with_person:
  - "every substantive reply"
  - "the complaint"
  - "deciding a supplier invoice is genuine"
---

# Inbox Triage Build Standard

**Spec:** AIP-BS-INBOX-TRIAGE · **Version:** 2026-09-26 · **Canonical:** https://aipathway.com.au/explore-ai/inbox-triage-build-standard
...
The full specification is in `reference/inbox-triage.md` in this skill. Read it
...
For the current version, fetch https://aipathway.com.au/explore-ai/inbox-triage-build-standard.md. This copy is 2026-09-26.

The checks are also structured data, so you do not have to infer a test plan from
the prose: https://aipathway.com.au/explore-ai/inbox-triage-build-standard/checks.json gives each check a stable id, the ports it
observes, what to inject and what to assert. `npx @aipathway/conformance show
inbox-triage-build-standard` prints them and comes with a stub and a runner, so a build can be
...
AIP-BS-INBOX-TRIAGE, 2026-09-26, AI Pathway, https://aipathway.com.au/explore-ai/inbox-triage-build-standard
