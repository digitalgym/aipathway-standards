...
**Spec:** AIP-BS-MULTI-SITE-CONFORMANCE · **Version:** 2026-09-17 · **Canonical:** https://aipathway.com.au/explore-ai/multi-site-conformance-build-standard
...
The full specification is in `reference/multi-site-conformance.md` in this skill. Read it
...
For the current version, fetch https://aipathway.com.au/explore-ai/multi-site-conformance-build-standard.md. This copy is 2026-09-17.

The checks are also structured data, so you do not have to infer a test plan from
the prose: https://aipathway.com.au/explore-ai/multi-site-conformance-build-standard/checks.json gives each check a stable id, the ports it
observes, what to inject and what to assert. `npx @aipathway/conformance show
multi-site-conformance-build-standard` prints them and comes with a stub and a runner, so a build can be
...
AIP-BS-MULTI-SITE-CONFORMANCE, 2026-09-17, AI Pathway, https://aipathway.com.au/explore-ai/multi-site-conformance-build-standard
