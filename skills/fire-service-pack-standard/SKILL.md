...
The full specification is in `reference/fire-service-pack-standard.md` in this skill. Read it
...
fire-service-pack-standard` prints them and comes with a stub and a runner, so a build can be
